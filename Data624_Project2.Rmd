...
```{r bwplot}
bwplot(resamples(list(PLS=pls.fit, MARS=mars_model, SVM=svm_model, RandFrst=rf_model,  Cubist=cubist_model, SingTree=st_model, Boosting=gbm_model)), main = "Models Comparison")
```
